...
asn_TYPE_member_t asn_MBR_MessageType_Choice_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MessageType_Choice, choice.messageType_Choice_NI),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MessageType_Choice, choice.messageType_Choice_RRC),
