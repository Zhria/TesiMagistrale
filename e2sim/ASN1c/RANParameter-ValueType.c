...
asn_TYPE_member_t asn_MBR_RANParameter_ValueType_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RANParameter_ValueType, choice.ranP_Choice_ElementTrue),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANParameter_ValueType, choice.ranP_Choice_ElementFalse),
