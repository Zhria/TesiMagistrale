...
typedef struct TriggerType_Choice {
	...
	union TriggerType_Choice_u {
		TriggerType_Choice_RRCstate_t	 triggerType_Choice_RRCstate;
		TriggerType_Choice_UEID_t	 triggerType_Choice_UEID;
		TriggerType_Choice_L2state_t	 triggerType_Choice_L2state;
		/*
