...
typedef struct E2SM_RC_ControlOutcome {
	struct E2SM_RC_ControlOutcome__ric_controlOutcome_formats {
		...
		union E2SM_RC_ControlOutcome__ric_controlOutcome_formats_u {
			E2SM_RC_ControlOutcome_Format1_t	 controlOutcome_Format1;
			/*
			 * This type is extensible,
			 * possible extensions are below.
			 */
			E2SM_RC_ControlOutcome_Format2_t	 controlOutcome_Format2;
			E2SM_RC_ControlOutcome_Format3_t	 controlOutcome_Format3;
		} choice;
