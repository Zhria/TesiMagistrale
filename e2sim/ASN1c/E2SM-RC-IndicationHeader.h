...
typedef struct E2SM_RC_IndicationHeader {
	struct E2SM_RC_IndicationHeader__ric_indicationHeader_formats {
		...
		union E2SM_RC_IndicationHeader__ric_indicationHeader_formats_u {
			E2SM_RC_IndicationHeader_Format1_t	 indicationHeader_Format1;
			E2SM_RC_IndicationHeader_Format2_t	 indicationHeader_Format2;
			/*
			 * This type is extensible,
			 * possible extensions are below.
			 */
			E2SM_RC_IndicationHeader_Format3_t	 indicationHeader_Format3;
		} choice;
