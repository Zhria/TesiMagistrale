...
static asn_CHOICE_specifics_t asn_SPC_value_specs_4 = {
	sizeof(struct ProtocolIE_Field_75P0__value),
	offsetof(struct ProtocolIE_Field_75P0__value, _asn_ctx),
	offsetof(struct ProtocolIE_Field_75P0__value, present),
	sizeof(((struct ProtocolIE_Field_75P0__value *)0)->present),
	0,	/* No top level tags */
...
asn_TYPE_member_t asn_MBR_ProtocolIE_Field_75P0_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ProtocolIE_Field_75P0, id),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ProtocolIE_Field_75P0, criticality),
	...
	{ ATF_OPEN_TYPE | ATF_NOFLAGS, 0, offsetof(struct ProtocolIE_Field_75P0, value),
		-1 /* Ambiguous tag (ANY?) */,
		0,
		&asn_DEF_value_4,
		0,
...
static const ber_tlv_tag_t asn_DEF_ProtocolIE_Field_75P0_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ProtocolIE_Field_75P0_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 0, 0, 0 }, /* id */
    { (ASN_TAG_CLASS_UNIVERSAL | (10 << 2)), 1, 0, 0 } /* criticality */
};
asn_SEQUENCE_specifics_t asn_SPC_ProtocolIE_Field_75P0_specs_1 = {
	sizeof(struct ProtocolIE_Field_75P0),
	offsetof(struct ProtocolIE_Field_75P0, _asn_ctx),
	asn_MAP_ProtocolIE_Field_75P0_tag2el_1,
	2,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_ProtocolIE_Field_75P0 = {
	"ProtocolIE-Field",
	"ProtocolIE-Field",
	&asn_OP_SEQUENCE,
	asn_DEF_ProtocolIE_Field_75P0_tags_1,
	sizeof(asn_DEF_ProtocolIE_Field_75P0_tags_1)
		/sizeof(asn_DEF_ProtocolIE_Field_75P0_tags_1[0]), /* 1 */
	asn_DEF_ProtocolIE_Field_75P0_tags_1,	/* Same as above */
	sizeof(asn_DEF_ProtocolIE_Field_75P0_tags_1)
		/sizeof(asn_DEF_ProtocolIE_Field_75P0_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_ProtocolIE_Field_75P0_1,
	3,	/* Elements count */
	&asn_SPC_ProtocolIE_Field_75P0_specs_1	/* Additional specs */
};
