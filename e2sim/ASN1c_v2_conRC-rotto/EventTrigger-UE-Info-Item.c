...
static asn_TYPE_member_t asn_MBR_ueType_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EventTrigger_UE_Info_Item__ueType, choice.ueType_Choice_Individual),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EventTrigger_UE_Info_Item__ueType, choice.ueType_Choice_Group),
