...
typedef struct E2SM_RC_IndicationMessage {
	struct E2SM_RC_IndicationMessage__ric_indicationMessage_formats {
		...
		union E2SM_RC_IndicationMessage__ric_indicationMessage_formats_u {
			E2SM_RC_IndicationMessage_Format1_t	 indicationMessage_Format1;
			E2SM_RC_IndicationMessage_Format2_t	 indicationMessage_Format2;
			E2SM_RC_IndicationMessage_Format3_t	 indicationMessage_Format3;
			E2SM_RC_IndicationMessage_Format4_t	 indicationMessage_Format4;
			E2SM_RC_IndicationMessage_Format5_t	 indicationMessage_Format5;
			/*
			 * This type is extensible,
			 * possible extensions are below.
			 */
			E2SM_RC_IndicationMessage_Format6_t	 indicationMessage_Format6;
		} choice;
