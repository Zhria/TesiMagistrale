...
typedef struct E2SM_RC_ActionDefinition {
	...
	struct E2SM_RC_ActionDefinition__ric_actionDefinition_formats {
		...
		union E2SM_RC_ActionDefinition__ric_actionDefinition_formats_u {
			E2SM_RC_ActionDefinition_Format1_t	 actionDefinition_Format1;
			E2SM_RC_ActionDefinition_Format2_t	 actionDefinition_Format2;
			E2SM_RC_ActionDefinition_Format3_t	 actionDefinition_Format3;
			/*
			 * This type is extensible,
			 * possible extensions are below.
			 */
			E2SM_RC_ActionDefinition_Format4_t	 actionDefinition_Format4;
		} choice;
