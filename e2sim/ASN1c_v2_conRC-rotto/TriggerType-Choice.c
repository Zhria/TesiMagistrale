...
asn_TYPE_member_t asn_MBR_TriggerType_Choice_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TriggerType_Choice, choice.triggerType_Choice_RRCstate),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TriggerType_Choice, choice.triggerType_Choice_UEID),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TriggerType_Choice, choice.triggerType_Choice_L2state),
