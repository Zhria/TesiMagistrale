 ...
 * 	found in "./Downloads/e2sm_rc_v1_03_standard.asn"
 * 	`asn1c -fcompound-names -D ./testRC1.0.3/`
 */
...
static asn_TYPE_member_t asn_MBR_ric_indicationMessage_formats_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct E2SM_RC_IndicationMessage__ric_indicationMessage_formats, choice.indicationMessage_Format1),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct E2SM_RC_IndicationMessage__ric_indicationMessage_formats, choice.indicationMessage_Format2),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct E2SM_RC_IndicationMessage__ric_indicationMessage_formats, choice.indicationMessage_Format3),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct E2SM_RC_IndicationMessage__ric_indicationMessage_formats, choice.indicationMessage_Format5),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct E2SM_RC_IndicationMessage__ric_indicationMessage_formats, choice.indicationMessage_Format6),
